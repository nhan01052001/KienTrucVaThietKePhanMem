package com.example.sbJwt.spring_boot_jwt.config;
...
import com.example.sbJwt.spring_boot_jwt.rest.CustomAccessDeniedHandler;
import com.example.sbJwt.spring_boot_jwt.rest.JwtAuthenticationTokenFilter;
import com.example.sbJwt.spring_boot_jwt.rest.RestAuthenticationEntryPoint;
@Configuration
@EnableWebSecurity
